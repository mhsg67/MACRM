...
class ClusterDatastructureTest extends UnitSpec {
    ...
    "updateClusterStructure" should "change newSamplingRate && add new Servers && remove some Servers" in {
        ...
        val n1 = new NodeReport(nId1, new Resource(2, 1000), null, null, null, NodeState("NEW"), 0)
        val n2 = new NodeReport(nId2, new Resource(2, 1000), null, null, null, NodeState("NEW"), 0)
        val n3 = new NodeReport(nId3, new Resource(2, 1000), null, null, null, NodeState("NEW"), 0)
        val n4 = new NodeReport(nId4, new Resource(2, 1000), null, null, null, NodeState("NEW"), 0)
        val n5 = new NodeReport(nId5, new Resource(2, 1000), null, null, null, NodeState("NEW"), 0)
        val n6 = new NodeReport(nId6, new Resource(2, 1000), null, null, null, NodeState("NEW"), 0)
        val newN1 = new NodeReport(nId1, new Resource(4, 2000), null, null, null, NodeState("NEW"), 0)
        val newN4 = new NodeReport(nId7, new Resource(8, 8000), null, null, null, NodeState("NEW"), 0)
    ...
    "getMatchCapablitiesOfNode" should "return list of node with related capablity" in {
        ...
        val n1 = new NodeReport(nId1, new Resource(2, 1000), List(co7), null, null, NodeState("NEW"), 0)
        val n2 = new NodeReport(nId2, new Resource(2, 1000), List(co1, co8), null, null, NodeState("NEW"), 0)
        val n3 = new NodeReport(nId3, new Resource(2, 1000), List(co2), null, null, NodeState("NEW"), 0)
        val n4 = new NodeReport(nId4, new Resource(2, 1000), List(co2, co4, co8), null, null, NodeState("NEW"), 0)
        val n5 = new NodeReport(nId5, new Resource(2, 1000), List(co3, co8), null, null, NodeState("NEW"), 0)
        val n6 = new NodeReport(nId6, new Resource(2, 1000), List(co4, co2), null, null, NodeState("NEW"), 0)
        val n7 = new NodeReport(nId7, new Resource(4, 2000), List(co5, co1, co3, co7), null, null, NodeState("NEW"), 0)
        val n8 = new NodeReport(nId8, new Resource(8, 8000), List(co6, co2, co3, co7), null, null, NodeState("NEW"), 0)
